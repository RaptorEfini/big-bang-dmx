...
const u = ":host{display:block;width:100%}.button-group{display:flex;gap:var(--spacing-sm);padding:var(--spacing-xs);background:#0d0221b3;border-radius:var(--border-radius);position:relative;-webkit-backdrop-filter:blur(5px);backdrop-filter:blur(5px)}.horizontal{flex-wrap:wrap}::slotted(darkglow-button){margin:0;transition:transform .2s ease,box-shadow .2s ease}::slotted(darkglow-button:hover){transform:translateY(-2px);filter:brightness(1.2)}";
class b extends HTMLElement {
  ...
  render() {
    ...
    switch (this.align) {
      case "start":
        e = "flex-start", t = "flex-start";
        break;
      case "end":
        e = "flex-end", t = "flex-end";
        break;
      case "center":
      default:
        e = "center", t = "center";
...
class y extends HTMLElement {
  ...
  constructor() {
    super(), Object.defineProperty(this, "_value", {
      ...
      value: (e) => {
        var t;
        this.disabled || (this._isDragging = !0, this._startY = e.clientY, this._startX = e.clientX, (t = this._handleElement) == null || t.classList.add("active"), e.preventDefault());
      }
      ...
      value: (e) => {
        if (!this._isDragging)
          return;
        const t = this._max - this._min;
        let r;
        this.orientation === "horizontal" ? (r = (e.clientX - this._startX) * this._sensitivity * (t / 100), this._startX = e.clientX) : (r = (this._startY - e.clientY) * this._sensitivity * (t / 100), this._startY = e.clientY), this.value = this._value + r;
      }
      ...
      value: () => {
        var e;
        this._isDragging && (this._isDragging = !1, (e = this._handleElement) == null || e.classList.remove("active"));
      }
      ...
      value: (e) => {
        if (this.disabled)
          return;
        e.preventDefault();
        const t = this.orientation === "horizontal" ? e.deltaY > 0 ? 1 : -1 : e.deltaY > 0 ? -1 : 1, r = (this._max - this._min) / 100;
        this.value = this._value + t * r * 5;
      }
    }), this.attachShadow({ mode: "open" }), this.render();
  }
  connectedCallback() {
    var e, t, r, a;
    this._faderElement = (e = this.shadowRoot) == null ? void 0 : e.querySelector(".fader-track"), this._handleElement = (t = this.shadowRoot) == null ? void 0 : t.querySelector(".fader-handle"), this._valueDisplay = (r = this.shadowRoot) == null ? void 0 : r.querySelector(".value-display"), (a = this._handleElement) == null || a.addEventListener("mousedown", this.handleMouseDown), document.addEventListener("mousemove", this.handleMouseMove), document.addEventListener("mouseup", this.handleMouseUp), this.addEventListener("wheel", this.handleWheel), this.updateFaderPosition();
  }
  disconnectedCallback() {
    var e;
    (e = this._handleElement) == null || e.removeEventListener("mousedown", this.handleMouseDown), document.removeEventListener("mousemove", this.handleMouseMove), document.removeEventListener("mouseup", this.handleMouseUp), this.removeEventListener("wheel", this.handleWheel);
  }
  attributeChangedCallback(e, t, r) {
    if (t !== r)
      switch (e) {
        case "value":
          this._value = isNaN(Number(r)) ? 50 : Number(r), this.updateFaderPosition();
          break;
        case "min":
          this._min = isNaN(Number(r)) ? 0 : Number(r), this.updateFaderPosition();
          break;
        case "max":
          this._max = isNaN(Number(r)) ? 100 : Number(r), this.updateFaderPosition();
          break;
        case "disabled":
        case "variant":
        case "orientation":
  ...
  set value(e) {
    const t = Math.min(Math.max(e, this._min), this._max);
    t !== this._value && (this._value = t, this.setAttribute("value", String(t)), this.updateFaderPosition(), this.dispatchEvent(new CustomEvent("change", {
      bubbles: !0,
      composed: !0,
  ...
  set min(e) {
    this._min = e, this.setAttribute("min", String(e));
  }
  get max() {
    return this._max;
  }
  set max(e) {
    this._max = e, this.setAttribute("max", String(e));
  }
  get disabled() {
    return this.hasAttribute("disabled");
  }
  ...
  updateFaderPosition() {
    if (!this._handleElement || !this._valueDisplay)
      return;
    const e = (this._value - this._min) / (this._max - this._min) * 100;
    if (this.orientation === "horizontal")
      this._handleElement.style.left = `${e}%`, this._handleElement.style.top = "50%", this._handleElement.style.transform = "translate(-50%, -50%)";
    else {
      const t = 100 - e;
      this._handleElement.style.top = `${t}%`, this._handleElement.style.left = "50%", this._handleElement.style.transform = "translateX(-50%)";
    }
  ...
  render() {
    if (!this.shadowRoot)
      return;
    const e = this.orientation === "horizontal", t = `
      :host {
    ...
    `;
    let r = '<div class="ticks">';
    for (let a = 0; a <= 10; a++) {
      const i = a * 10, s = a % 2 === 0;
    ...
    `, this._faderElement = this.shadowRoot.querySelector(".fader-track"), this._handleElement = this.shadowRoot.querySelector(".fader-handle"), this._valueDisplay = this.shadowRoot.querySelector(".value-display"), this.updateFaderPosition();
  }
}
const x = ":host{display:block;width:100%}.grid-container{display:grid;margin:var(--spacing-md) auto;padding:var(--spacing-sm);border-radius:var(--border-radius);position:relative;-webkit-backdrop-filter:blur(5px);backdrop-filter:blur(5px)}::slotted(*){transition:transform .2s ease,filter .2s ease}::slotted(*:hover){transform:translateY(-2px);filter:brightness(1.2)}";
class w extends HTMLElement {
  ...
  render() {
    ...
    let r = "transparent", a = "none", i = "none";
    switch (this.variant) {
      case "primary":
        r = "rgba(13, 2, 33, 0.7)", a = "1px solid var(--color-primary)", i = "0 0 10px rgba(0, 128, 255, 0.3)";
        break;
      case "secondary":
        r = "rgba(13, 2, 33, 0.7)", a = "1px solid var(--color-secondary)", i = "0 0 10px rgba(0, 255, 255, 0.3)";
        break;
      case "danger":
        r = "rgba(13, 2, 33, 0.7)", a = "1px solid var(--color-danger)", i = "0 0 10px rgba(255, 0, 0, 0.3)";
        break;
      case "accent":
        r = "rgba(13, 2, 33, 0.7)", a = "1px solid var(--color-accent)", i = "0 0 10px rgba(255, 0, 255, 0.3)";
        break;
      case "outlined":
        r = "transparent", a = "1px solid var(--color-border)";
        break;
      case "default":
      default:
        r = "rgba(13, 2, 33, 0.7)";
...
class _ extends HTMLElement {
  ...
  constructor() {
    super(), Object.defineProperty(this, "_value", {
      ...
      value: (e) => {
        var t;
        this.disabled || (this._isDragging = !0, this._startY = e.clientY, (t = this._knobElement) == null || t.classList.add("active"), e.preventDefault());
      }
    }), Object.defineProperty(this, "handleMouseMove", {
      enumerable: !0,
      configurable: !0,
      ...
      value: (e) => {
        if (!this._isDragging)
          return;
        const t = this._startY - e.clientY, r = this._max - this._min, a = t * this._sensitivity * (r / 100);
        this.value = this._value + a, this._startY = e.clientY;
      }
    }), Object.defineProperty(this, "handleMouseUp", {
      enumerable: !0,
      configurable: !0,
      ...
      value: () => {
        var e;
        this._isDragging && (this._isDragging = !1, (e = this._knobElement) == null || e.classList.remove("active"));
      }
    }), Object.defineProperty(this, "handleWheel", {
      enumerable: !0,
      configurable: !0,
      ...
      value: (e) => {
        if (this.disabled)
          return;
        e.preventDefault();
        const t = e.deltaY > 0 ? -1 : 1, r = (this._max - this._min) / 100;
        this.value = this._value + t * r * 5;
      }
    }), this.attachShadow({ mode: "open" }), this.render();
  }
  connectedCallback() {
    var e, t, r;
    this._knobElement = (e = this.shadowRoot) == null ? void 0 : e.querySelector(".knob"), this._indicatorElement = (t = this.shadowRoot) == null ? void 0 : t.querySelector(".indicator"), this._valueDisplay = (r = this.shadowRoot) == null ? void 0 : r.querySelector(".value-display"), this.addEventListener("mousedown", this.handleMouseDown), document.addEventListener("mousemove", this.handleMouseMove), document.addEventListener("mouseup", this.handleMouseUp), this.addEventListener("wheel", this.handleWheel), this.updateKnobPosition();
  }
  disconnectedCallback() {
    this.removeEventListener("mousedown", this.handleMouseDown), document.removeEventListener("mousemove", this.handleMouseMove), document.removeEventListener("mouseup", this.handleMouseUp), this.removeEventListener("wheel", this.handleWheel);
  }
  attributeChangedCallback(e, t, r) {
    if (t !== r)
      switch (e) {
        case "value":
          this._value = isNaN(Number(r)) ? 50 : Number(r), this.updateKnobPosition();
          break;
        case "min":
          this._min = isNaN(Number(r)) ? 0 : Number(r), this.updateKnobPosition();
          break;
        case "max":
          this._max = isNaN(Number(r)) ? 100 : Number(r), this.updateKnobPosition();
          break;
        case "disabled":
        case "variant":
          this.render();
  ...
  set value(e) {
    const t = Math.min(Math.max(e, this._min), this._max);
    t !== this._value && (this._value = t, this.setAttribute("value", String(t)), this.updateKnobPosition(), this.dispatchEvent(new CustomEvent("change", {
      bubbles: !0,
      composed: !0,
      detail: { value: this._value }
    })));
  ...
  updateKnobPosition() {
    if (!this._indicatorElement || !this._valueDisplay)
      return;
    const a = 225 + (this._value - this._min) / (this._max - this._min) * 100 * 285 / 100;
    this._indicatorElement.style.transform = `rotate(${a}deg)`, this._valueDisplay.textContent = Math.round(this._value).toString();
  }
  render() {
    if (!this.shadowRoot)
      return;
    ...
    `;
    let t = '<div class="ticks">';
    const r = 225, a = 150;
    for (let i = 0; i < 28; i++) {
      const s = i * 10, n = i % 9 === 0, l = Math.abs(s - r) < 5, d = Math.abs(s - a) < 5;
      t += `
        <div class="tick ${l || d ? "limit-marker" : n ? "major" : ""}" 
...
class E extends HTMLElement {
  ...
  constructor() {
    super(), Object.defineProperty(this, "_number", {
      ...
      writable: !0,
      value: (e) => {
        this.disabled || this.dispatchEvent(new CustomEvent("pad-click", {
          bubbles: !0,
          composed: !0,
      ...
      value: (e) => {
        var t;
        this.disabled || (t = this._padElement) == null || t.classList.add("pressed");
      }
    }), Object.defineProperty(this, "handleMouseUp", {
      enumerable: !0,
      configurable: !0,
      ...
      value: (e) => {
        var t;
        this.disabled || (t = this._padElement) == null || t.classList.remove("pressed");
      }
    }), this.attachShadow({ mode: "open" }), this.render();
  }
  connectedCallback() {
    var e, t;
    this._padElement = (e = this.shadowRoot) == null ? void 0 : e.querySelector(".pad"), this._numberElement = (t = this.shadowRoot) == null ? void 0 : t.querySelector(".number"), this.addEventListener("click", this.handleClick), this.addEventListener("mousedown", this.handleMouseDown), this.addEventListener("mouseup", this.handleMouseUp);
  }
  disconnectedCallback() {
    this.removeEventListener("click", this.handleClick), this.removeEventListener("mousedown", this.handleMouseDown), this.removeEventListener("mouseup", this.handleMouseUp);
  }
  attributeChangedCallback(e, t, r) {
    if (t !== r)
      switch (e) {
        case "number":
          this._number = r !== null ? Number(r) : null, this.updateNumberDisplay();
          break;
        case "variant":
        case "active":
        case "disabled":
  ...
  set number(e) {
    this._number = e, e === null ? this.removeAttribute("number") : this.setAttribute("number", String(e)), this.updateNumberDisplay();
  }
  get variant() {
    return this.getAttribute("variant") || "primary";
  }
  ...
  updateNumberDisplay() {
    this._numberElement && (this._number !== null ? (this._numberElement.textContent = String(this._number), this._numberElement.style.display = "flex") : this._numberElement.style.display = "none");
  }
  render() {
    if (!this.shadowRoot)
      return;
...
class C extends HTMLElement {
  ...
  render() {
    if (!this.shadowRoot)
      return;
    let e = "p";
    this.type === "title" ? e = "h1" : this.type === "subtitle" && (e = "h2"), this.shadowRoot.innerHTML = `
      <style>${M}</style>
...
class j extends HTMLElement {
  ...
  */
  ...
  render() {
    ...
    `, document.title = this.title, this.removeAttribute("title"));
  }
}
function O(o = "darkglow") {
  customElements.define(`${o}-button`, h), customElements.define(`${o}-button-group`, b), customElements.define(`${o}-card`, v), customElements.define(`${o}-container`, g), customElements.define(`${o}-fader`, y), customElements.define(`${o}-grid`, w), customElements.define(`${o}-knob`, _), customElements.define(`${o}-pad`, E), customElements.define(`${o}-typography`, C), customElements.define(`${o}-layout`, j);
}
export {
  h as ButtonComponent,
  b as ButtonGroupComponent,
  v as CardComponent,
  g as ContainerComponent,
  y as FaderComponent,
  w as GridComponent,
  _ as KnobComponent,
  j as LayoutComponent,
  E as PadComponent,
  C as TypographyComponent,
  O as registerComponents
};
//# sourceMappingURL=darkglow.js.map
